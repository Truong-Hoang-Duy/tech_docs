...
```text
Đọc tech_docs/rules/2_web-code-handoff.md và
...
> Nên task doc phải **chép nội dung cần thiết vào trong nó**, không link ngược về `research/`. Đây là ràng buộc cứng, xem `docs-convention.md` §3.1.
...
Bốn câu, bốn thời điểm. Giữa các câu đó Claude Code nằm im, không tốn gì.
...
| Người khác mở task doc thấy link chết | Task doc trỏ về `tech_docs/research/…` — họ không có repo đó | Chép nội dung vào task doc, xoá mọi đường dẫn `tech_docs/` (`docs-convention.md` §3.1) |
